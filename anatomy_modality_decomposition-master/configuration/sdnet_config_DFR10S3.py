...
from loaders import DFR10S3_data_loader
import json
#
loader = DFR10S3_data_loader
params = {
    'seed': 1,
    ...
    'dataset_name': 'emb',
    'test_dataset': 'emb',
    'input_shape': loader.DFR10S3().input_shape,
    'image_downsample': 1,
    'modality': 'MR',
    ...
    'lr': 0.0001,
    'decay': 0.0001,
    'model_dir': "/cs/casmip/nirm/embryo_project_version1/embyo_projects_codes/anatomy_modality_decomposition-master/" + 'experiment_DFR10S3',
    'results': "/cs/casmip/nirm/embryo_project_version1/embyo_projects_codes/anatomy_modality_decomposition-master/" + 'experiment_DFR10S3'+ '/results',

    'path_patch': "/cs/casmip/nirm/embryo_project_version1/Brain_data_raw/Brain_after/patch2D_merge3",
    'path_data_set': "/cs/casmip/nirm/embryo_project_version1/Brain_data_raw/dataset2d/DFR_10_3d_S2",
