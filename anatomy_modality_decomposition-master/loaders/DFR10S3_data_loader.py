...
class DFR10S3(Loader):
    """
    Abstract class defining the behaviour of loaders for different datasets.
    """
    def __init__(self):

        super(DFR10S3, self).__init__()

        self.base_dir = "/cs/casmip/nirm/embryo_project_version1/Brain_data"
        self.data_l_name = "DFR_10_2d_S3" + "_TL"
        self.data_u_name = "DFR_10_2d_S3" + "_TU"
        self.data_v_name = "DFR_10_2d_S3" + "_VA"
        self.data_t_name = "DFR_10_2d_S3" + "_TE"
