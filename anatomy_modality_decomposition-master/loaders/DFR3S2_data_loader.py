...
class DFR3S2(Loader):
    ...
    def __init__(self):
        ...
        super(DFR3S2, self).__init__()

        self.base_dir = "/cs/casmip/nirm/embryo_project_version1/Brain_data"
        self.data_l_name = "DFR_3_2d_S2" + "_TL"
        self.data_u_name = "DFR_3_2d_S2" + "_TU"
        self.data_v_name = "DFR_3_2d_S2" + "_VA"
        self.data_t_name = "DFR_3_2d_S2" + "_TE"
