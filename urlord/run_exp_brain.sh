...
==========================load data ===================================================================================
#python lord_unet.py --base-dir /mnt/local/nirm/Brain/Brain_data preprocess --dataset-id brain_dataset --dataset-path /mnt/local/nirm/Brain/2d_dataset/DFR_1_2d_S1/TRAIN/Labeled --data-name DFR_1_2d_S1_TL
#python lord_unet.py --base-dir /mnt/local/nirm/Brain/Brain_data preprocess --dataset-id brain_dataset --dataset-path /mnt/local/nirm/Brain/2d_dataset/DFR_1_2d_S1/TRAIN/ULabeled --data-name DFR_1_2d_S1_TU
#python lord_unet.py --base-dir /mnt/local/nirm/Brain/Brain_data preprocess --dataset-id brain_dataset --dataset-path /mnt/local/nirm/Brain/2d_dataset/DFR_1_2d_S1/VALIDATION --data-name DFR_1_2d_S1_VA
#python lord_unet.py --base-dir /mnt/local/nirm/Brain/Brain_data preprocess --dataset-id brain_dataset --dataset-path /mnt/local/nirm/Brain/2d_dataset/DFR_1_2d_S1/TEST --data-name DFR_1_2d_S1_TE
#
#python lord_unet.py --base-dir /mnt/local/nirm/Brain/Brain_data preprocess --dataset-id brain_dataset --dataset-path /mnt/local/nirm/Brain/2d_dataset/DFR_1_2d_S2/TRAIN/Labeled --data-name DFR_1_2d_S2_TL
#python lord_unet.py --base-dir /mnt/local/nirm/Brain/Brain_data preprocess --dataset-id brain_dataset --dataset-path /mnt/local/nirm/Brain/2d_dataset/DFR_1_2d_S2/TRAIN/ULabeled --data-name DFR_1_2d_S2_TU
#python lord_unet.py --base-dir /mnt/local/nirm/Brain/Brain_data preprocess --dataset-id brain_dataset --dataset-path /mnt/local/nirm/Brain/2d_dataset/DFR_1_2d_S2/VALIDATION --data-name DFR_1_2d_S2_VA
#python lord_unet.py --base-dir /mnt/local/nirm/Brain/Brain_data preprocess --dataset-id brain_dataset --dataset-path /mnt/local/nirm/Brain/2d_dataset/DFR_1_2d_S2/TEST --data-name DFR_1_2d_S2_TE
#
#
#python lord_unet.py --base-dir /mnt/local/nirm/Brain/Brain_data preprocess --dataset-id brain_dataset --dataset-path /mnt/local/nirm/Brain/2d_dataset/DFR_1_2d_S3/TRAIN/Labeled --data-name DFR_1_2d_S3_TL
#python lord_unet.py --base-dir /mnt/local/nirm/Brain/Brain_data preprocess --dataset-id brain_dataset --dataset-path /mnt/local/nirm/Brain/2d_dataset/DFR_1_2d_S3/TRAIN/ULabeled --data-name DFR_1_2d_S3_TU
#python lord_unet.py --base-dir /mnt/local/nirm/Brain/Brain_data preprocess --dataset-id brain_dataset --dataset-path /mnt/local/nirm/Brain/2d_dataset/DFR_1_2d_S3/VALIDATION --data-name DFR_1_2d_S3_VA
#python lord_unet.py --base-dir /mnt/local/nirm/Brain/Brain_data preprocess --dataset-id brain_dataset --dataset-path /mnt/local/nirm/Brain/2d_dataset/DFR_1_2d_S3/TEST --data-name DFR_1_2d_S3_TE
...
#python lord_unet.py --base-dir /mnt/local/nirm/Brain/Brain_data preprocess --dataset-id brain_dataset --dataset-path /mnt/local/nirm/Brain/2d_dataset/DFR_44_2d/TRAIN/ULabeled --data-name DFR_44_2d_TU
